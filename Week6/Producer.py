...
def simulator_thread(simulator: MetricSimulator, interval: float = 2.0):
...
def main(config_files):
    ...
    for cfg_path in config_files:
        try:
            ...
            threading.Thread(target=simulator_thread, args=(sim,), daemon=True).start()
    ...
    try:
        ...
        print("\nExiting... Flushing Kafka producer.")
        producer.flush()
